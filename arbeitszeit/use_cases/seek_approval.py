...
class SeekApproval:
    ...
    def __call__(
        ...
        """Company seeks plan approval. Either for a new plan or for a plan
        reneweal.  Sets approved either to True or False, sets
        approval_date and approval_reason.

        Additionally, if it's a plan renewal, the original plan will
        be set to "renewed".  Returns the approval decision.
        """
