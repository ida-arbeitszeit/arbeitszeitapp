...
class ShowPAccountDetailsTests(BaseTestCase):
    def setUp(self) -> None:
        super().setUp()
        self.interactor = self.injector.get(ShowPAccountDetailsInteractor)
    ...
    ) -> ShowPAccountDetailsInteractor.Request:
        return ShowPAccountDetailsInteractor.Request(company=company_id)
