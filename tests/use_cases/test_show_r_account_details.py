...
class UseCaseTester(BaseTestCase):
    ...
    def test_no_transactions_returned_when_company_has_neither_consumed_nor_planned_r(
        self,
    ) -> None:
    ...
    def test_that_after_consumption_of_liquid_means_of_production_a_transaction_of_that_type_is_shown(
        self,
    ) -> None:
    ...
    def test_that_after_consumption_of_liquid_means_a_transaction_with_volume_of_negated_costs_is_shown(
        self,
    ) -> None:
        consumer = self.company_generator.create_company()
