...
class RegisterCompanyControllerTests(BaseTestCase):
    ...
    def test_that_valid_email_from_form_is_used_in_use_case_request(self) -> None:
    ...
    def test_that_name_from_form_is_used_in_use_case_request(self) -> None:
    ...
    def test_that_password_from_form_is_use_in_use_case_request(self) -> None:
