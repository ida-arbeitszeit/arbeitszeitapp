...
class RequestEmailAddressChangePresenter:
    ...
    def render_response(
        self, uc_response: interactor.Response, form: RequestEmailAddressChangeForm
    ) -> ViewModel:
        match uc_response.rejection_reason:
            ...
            case interactor.Response.RejectionReason.invalid_email_address:
            ...
            case (
                interactor.Response.RejectionReason.current_email_address_does_not_exist
            ):
                self._notify_about_rejection()
                return ViewModel(redirect_url=None)
            case interactor.Response.RejectionReason.new_email_address_already_taken:
                form.new_email_field.attach_error(
