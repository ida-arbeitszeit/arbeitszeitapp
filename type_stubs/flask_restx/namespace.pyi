...
from .marshalling import marshal as marshal, marshal_with as marshal_with
...
class Namespace:
    ...
    apis: Incomplete
    logger: Incomplete
    def __init__(self, name, description: Incomplete | None = ..., path: Incomplete | None = ..., decorators: Incomplete | None = ..., validate: Incomplete | None = ..., authorizations: Incomplete | None = ..., ordered: bool = ..., **kwargs) -> None: ...
    @property
    def path(self): ...
    def add_resource(self, resource, *urls, **kwargs) -> None: ...
    def route(self, *urls, **kwargs): ...
    def doc(self, shortcut: Incomplete | None = ..., **kwargs): ...
    def hide(self, func): ...
    def abort(self, *args, **kwargs) -> None: ...
    def add_model(self, name, definition): ...
    def model(self, name: Incomplete | None = ..., model: Incomplete | None = ..., mask: Incomplete | None = ..., strict: bool = ..., **kwargs): ...
    def schema_model(self, name: Incomplete | None = ..., schema: Incomplete | None = ...): ...
    ...
    def marshal_with(self, fields, as_list: bool = ..., code=..., description: Incomplete | None = ..., **kwargs): ...
    def marshal_list_with(self, fields, **kwargs): ...
    def marshal(self, *args, **kwargs): ...
    def errorhandler(self, exception): ...
    def param(self, name, description: Incomplete | None = ..., _in: str = ..., **kwargs): ...
    def response(self, code, description, model: Incomplete | None = ..., **kwargs): ...
    def header(self, name, description: Incomplete | None = ..., **kwargs): ...
