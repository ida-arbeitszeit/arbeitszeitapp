...
from .model import Model as Model, ModelBase as ModelBase, OrderedModel as OrderedModel
from .reqparse import RequestParser as RequestParser
from .utils import merge as merge, not_none as not_none, not_none_sorted as not_none_sorted
...
def is_hidden(resource, route_doc: Incomplete | None = ...): ...
...
class Swagger:
    ...
    def extract_resource_doc(self, resource, url, route_doc: Incomplete | None = ...): ...
    def expected_params(self, doc): ...
    def register_errors(self): ...
    def serialize_resource(self, ns, resource, url, route_doc: Incomplete | None = ..., **kwargs): ...
    ...
    def process_headers(self, response, doc, method: Incomplete | None = ..., headers: Incomplete | None = ...): ...
