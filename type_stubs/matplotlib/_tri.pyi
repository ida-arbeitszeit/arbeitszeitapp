...
class TrapezoidMapTriFinder:
    ...
    def find_many(
        self, arg0: numpy.ndarray[numpy.float64], arg1: numpy.ndarray[numpy.float64]
...
class TriContourGenerator:
    def __init__(
        self, triangulation: Triangulation, z: numpy.ndarray[numpy.float64]
    ) -> None: ...
...
class Triangulation:
    def __init__(
        ...
        neighbors: numpy.ndarray[numpy.int32],
        correct_triangle_orientations: bool,
    ) -> None: ...
    def calculate_plane_coefficients(
        self, arg0: numpy.ndarray[numpy.float64]
