...
class Tick(martist.Artist):
    ...
    label1: Incomplete
    label2: Incomplete
    def __init__(self, axes, loc, *, size: Incomplete | None = ..., width: Incomplete | None = ..., color: Incomplete | None = ..., tickdir: Incomplete | None = ..., pad: Incomplete | None = ..., labelsize: Incomplete | None = ..., labelcolor: Incomplete | None = ..., labelfontfamily: Incomplete | None = ..., zorder: Incomplete | None = ..., gridOn: Incomplete | None = ..., tick1On: bool = ..., tick2On: bool = ..., label1On: bool = ..., label2On: bool = ..., major: bool = ..., labelrotation: int = ..., grid_color: Incomplete | None = ..., grid_linestyle: Incomplete | None = ..., grid_linewidth: Incomplete | None = ..., grid_alpha: Incomplete | None = ..., **kwargs) -> None: ...
...
class Axis(martist.Artist):
    ...
    units: Incomplete
    def __init__(self, axes, *, pickradius: int = ..., clear: bool = ...) -> None: ...
    @property
