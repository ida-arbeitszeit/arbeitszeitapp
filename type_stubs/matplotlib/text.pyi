...
class Text(Artist):
    ...
    def __init__(
        ...
        *,
        ...
        multialignment: Incomplete | None = None,
        fontproperties: Incomplete | None = None,
        rotation: Incomplete | None = None,
        linespacing: Incomplete | None = None,
        rotation_mode: Incomplete | None = None,
        usetex: Incomplete | None = None,
        wrap: bool = False,
        transform_rotates_text: bool = False,
        parse_math: Incomplete | None = None,
    ...
    def get_window_extent(
        self, renderer: Incomplete | None = None, dpi: Incomplete | None = None
    ): ...
...
class _AnnotationBase:
    ...
    xycoords: Incomplete
    def __init__(
        self, xy, xycoords: str = "data", annotation_clip: Incomplete | None = None
    ) -> None: ...
