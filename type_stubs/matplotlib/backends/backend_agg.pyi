...
class FigureCanvasAgg(FigureCanvasBase):
    ...
    def tostring_argb(self): ...
    def buffer_rgba(self): ...
    def print_raw(self, filename_or_obj, *, metadata: Incomplete | None = ...) -> None: ...
    print_rgba = print_raw
    def print_png(self, filename_or_obj, *, metadata: Incomplete | None = ..., pil_kwargs: Incomplete | None = ...) -> None: ...
    def print_to_buffer(self): ...
    def print_jpg(self, filename_or_obj, *, metadata: Incomplete | None = ..., pil_kwargs: Incomplete | None = ...) -> None: ...
    print_jpeg = print_jpg
    def print_tif(self, filename_or_obj, *, metadata: Incomplete | None = ..., pil_kwargs: Incomplete | None = ...) -> None: ...
    print_tiff = print_tif
    def print_webp(self, filename_or_obj, *, metadata: Incomplete | None = ..., pil_kwargs: Incomplete | None = ...) -> None: ...
