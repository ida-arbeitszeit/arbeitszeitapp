...
class Colorbar:
    ...
    def __init__(self, ax, mappable: Incomplete | None = ..., *, cmap: Incomplete | None = ..., norm: Incomplete | None = ..., alpha: Incomplete | None = ..., values: Incomplete | None = ..., boundaries: Incomplete | None = ..., orientation: Incomplete | None = ..., ticklocation: str = ..., extend: Incomplete | None = ..., spacing: str = ..., ticks: Incomplete | None = ..., format: Incomplete | None = ..., drawedges: bool = ..., filled: bool = ..., extendfrac: Incomplete | None = ..., extendrect: bool = ..., label: str = ..., location: Incomplete | None = ...) -> None: ...
    @property
    def locator(self): ...
    @property
