...
class Container(tuple):
    ...
    def __init__(self, kl, label: Incomplete | None = ...) -> None: ...
    def remove(self): ...
...
class BarContainer(Container):
    ...
    def __init__(self, patches, errorbar: Incomplete | None = ..., *, datavalues: Incomplete | None = ..., orientation: Incomplete | None = ..., **kwargs) -> None: ...
