...
def encode_cookie(payload, key: Incomplete | None = None): ...
def decode_cookie(cookie, key: Incomplete | None = None): ...
def make_next_param(login_url, current_url): ...
def expand_login_view(login_view): ...
def login_url(
    login_view, next_url: Incomplete | None = None, next_field: str = "next"
): ...
def login_fresh(): ...
...
def set_login_view(login_view, blueprint: Incomplete | None = None) -> None: ...
