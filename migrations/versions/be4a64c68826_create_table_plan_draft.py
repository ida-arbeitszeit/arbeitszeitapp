...
def upgrade():
    ...
    with op.batch_alter_table("plan") as batch_op:
        batch_op.drop_column("social_accounting")
...
def downgrade():
    ...
    op.add_column(
        "plan",
        sa.Column(
            "social_accounting", sa.VARCHAR(), autoincrement=False, nullable=True
        ),
    )
    with op.batch_alter_table("plan") as batch_op:
        batch_op.create_foreign_key(
            "plan_social_accounting_fkey",
            "social_accounting",
            ["social_accounting"],
            ["id"],
        )
        ...
        batch_op.alter_column("social_accounting", nullable=False)
