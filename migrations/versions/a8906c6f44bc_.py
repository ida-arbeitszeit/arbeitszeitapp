...
Revision ID: a8906c6f44bc
Revises: 
Create Date: 2021-08-12 11:29:44.931368
...
def upgrade():
    ...
    sa.Column('account_from', sa.String(), nullable=False),
    sa.Column('account_to', sa.String(), nullable=False),
    ...
    sa.Column('angebot', sa.String(), nullable=False),
